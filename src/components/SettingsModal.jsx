...
export default function SettingsModal({ onClose }) {
    const { preferredUnit, toggleUnit } = useWorkout();
    ...
    return (
        <div style={{
            ...
            <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ marginTop: '1rem', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.5rem', color: 'var(--text-muted)', fontSize: '0.8rem', lineHeight: '1.6' }}>
                    <p style={{ margin: 0 }}>Version 1.2.0</p>
                    <p style={{ margin: 0 }}>Updated: Dec 31, 2025</p>
                    <p style={{ margin: '0.5rem 0 0 0', color: '#fff' }}>&copy; Martin Nanni 2025</p>
                </div>
            </div>
        </div>
    );
